...
class TestWordAPI:
    ...
    def test_wordy_pyramid_refactored(self, exercise1):
        """Test that wordy_pyramid uses the refactored list_of_words_with_lengths function."""
        import inspect

        source = inspect.getsource(exercise1.wordy_pyramid)
        assert "list_of_words_with_lengths" in source, (
            "💡 You should refactor wordy_pyramid to use list_of_words_with_lengths!\n"
